...
(function() {
  var MODULE_NAME, SLIDER_TAG, addAnimation, angularize, bindHtml, gap, halfWidth, hide, module, offset, offsetLeft, pixelize, removeAnimation, roundStep, show, sliderDirective, width;
      ...
      compile: function(element, attributes) {
        ...
        return {
          post: function(scope, element, attributes) {
            ...
            updateDOM = function() {
              var adjustBubbles, bindMouseToPointer, fitToBar, percentOffset, percentToOffset, percentValue, setBindings, setPointers;
