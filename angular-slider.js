...
(function() {
  var MODULE_NAME, SLIDER_TAG, addAnimation, angularize, bindHtml, gap, halfWidth, hide, module, offset, offsetLeft, percentize, pixelize, removeAnimation, roundStep, show, sliderDirective, width;
  ...
  percentize = function(position) {
    return "" + position + "%";
  };

  addAnimation = function(elements) {
    var element, _i, _len, _results;

    _results = [];
    for (_i = 0, _len = elements.length; _i < _len; _i++) {
      element = elements[_i];
      _results.push(element.addClass('animated'));
    }
    return _results;
  };

  removeAnimation = function(elements) {
    var element, _i, _len, _results;

    _results = [];
    for (_i = 0, _len = elements.length; _i < _len; _i++) {
      element = elements[_i];
      _results.push(element.removeClass('animated'));
    }
    return _results;
  };
      ...
      compile: function(element, attributes) {
        ...
        return {
          post: function(scope, element, attributes) {
            var barWidth, bindMouse, dimensions, maxOffset, maxValue, minOffset, minValue, ngDocument, offsetRange, pointerHalfWidth, updateDOM, valueRange, w, _j, _len1;
            ...
            updateDOM = function() {
              var adjustBubbles, bindMouseToPointer, fitToBar, percentOffset, percentValue, setBindings, setPointers;
              ...
              setPointers = function() {
                ...
                if (range) {
                  ...
                  selBar.css({
                    width: percentize(newHighValue - newLowValue)
                  });
              ...
              bindMouseToPointer = function(pointer, ref) {
                return pointer.bind('mousedown', function(event) {
                  dimensions();
                  event.stopPropagation();
                  event.preventDefault();
                  ngDocument.bind('mousemove', function(event) {
                  ...
                  return ngDocument.bind('mouseup', function() {
                    ngDocument.unbind('mousemove');
                    return ngDocument.unbind('mouseup');
                  });
                });
              };
              setBindings = function() {
                ...
                return bindMouseToPointer(maxPtr, refHigh);
              };
              setPointers();
              adjustBubbles();
              if (!bindMouse) {
  ...
  module = function(window, angular) {
    return angular.module(MODULE_NAME, []).directive(SLIDER_TAG, sliderDirective);
  };
