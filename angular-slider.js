      ...
      compile: function(element, attributes) {
        ...
        return {
          post: function(scope, element, attributes) {
            var barWidth, boundToInputs, dimensions, maxOffset, maxValue, minOffset, minValue, ngDocument, offsetRange, pointerHalfWidth, sliderStyle, updateDOM, valueRange, w, _j, _len1;
            boundToInputs = false;
            ...
            sliderStyle = 'default';
            if (!angular.isUndefined(attributes.sliderStyleNone)) {
              sliderStyle = null;
            }
            ...
            if (sliderStyle) {
              return element.addClass(sliderStyle);
            }
          }
        };
      }
